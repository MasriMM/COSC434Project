...
<div class="max-w-lg mx-auto mt-10 p-6 bg-gray-800 rounded-lg shadow-lg">
    ...
    <!-- Card Info -->
    <div class="mb-4">
        <input type="text" id="cardNumber" placeholder="Card Number" class="w-full px-4 py-2 mb-2 rounded bg-gray-700 text-white placeholder-gray-400">
        <div class="flex space-x-4">
            <input type="text" id="expiryDate" placeholder="MM/YY" class="w-1/2 px-4 py-2 rounded bg-gray-700 text-white placeholder-gray-400">
            <input type="text" id="cvv" placeholder="CVV" class="w-1/2 px-4 py-2 rounded bg-gray-700 text-white placeholder-gray-400">
        </div>
    </div>
...
<div id="popupModal" class="hidden fixed top-0 left-0 w-full h-full bg-black bg-opacity-50 flex items-center justify-center z-50">
    <div class="bg-gray-800 p-8 rounded-lg shadow-lg text-center z-60">
